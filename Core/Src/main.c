...
int main(void) {
  ...
  defaultTaskHandle = osThreadNew(StartDefaultTask, NULL, &defaultTask_attributes);
    ...
    straightRunHandle =
        osThreadNew(StartStraightRunTask, (void *)&straight_run_task_param,
                    &straightRun_attributes);

    /* creation of sendSpeed */
    sendSpeedHandle =
        osThreadNew(StartSendSpeedTask, (void *)&send_speed_task_param,
                    &sendSpeed_attributes);
