...
osThreadId_t cmdRobotPoseHandle;
const osThreadAttr_t cmdRobotPose_attributes = {
    .name = "cmdRobotPose",
    .stack_size = 1024 * 4,
...
int main(void) {
    ...
    DcMotorConfig left_wheel_motor_cfg = {
        ...
        .dir_port_a = DIRA_ROUE_GAUCHE_GPIO_Port,
    ...
    DcMotorConfig right_wheel_motor_cfg = {
        ...
        .dir_port_a = DIRA_ROUE_DROITE_GPIO_Port,
    ...
    DcMotorConfig levage_motor_cfg = {.htim_pwm = &htim10,
                                      .channel_number = TIM_CHANNEL_1,
    ...
    init_dc_motor(&lift_task_params.motor_levage, &levage_motor_cfg);
    init_encoder(&lift_task_params.encoder_levage, &levage_encoder_cfg);
    lift_task_params.strategy_task = &strategyHandle;

    //--Grip Task

    ServoMotorConfig gripCfg = {.htim_pwm = &htim9,
                                .channel_number = TIM_CHANNEL_2,
                                .pulse_min = 0.0005f,  // 0.5ms en secondes
                                .pulse_max = 0.0025f,  // 2.5ms en secondes
                                .angle_max = 180.0f,
    ...
    ServoMotorConfig spreadCfg = {.htim_pwm = &htim8,
                                  .channel_number = TIM_CHANNEL_1,
                                  .pulse_min = 0.0008f,  // 0.5ms en secondes
                                  .pulse_max = 0.0020f,  // 2.5ms en secondes
                                  .angle_max = 180.0f,
                                  .interrupt_mode = 0};
    ...
    CapteurUSConfig CapteurAvGaCfg = {&htim11,
                                      TIM_CHANNEL_1,
                                      TRIG_GAUCHE_AV_GPIO_Port,
                                      TRIG_GAUCHE_AV_Pin,
                                      ECHO_GAUCHE_AV_GPIO_Port,
                                      ECHO_GAUCHE_AV_Pin};
    CapteurUSConfig CapteurAvDrCfg = {&htim13,
                                      TIM_CHANNEL_1,
                                      TRIG_DROITE_AV_GPIO_Port,
                                      TRIG_DROITE_AV_Pin,
                                      ECHO_DROITE_AV_GPIO_Port,
                                      ECHO_DROITE_AV_Pin};
    ...
    /* creation of lift */
    liftHandle =
        osThreadNew(StartLiftTask, (void *)&lift_task_params, &lift_attributes);

    /* creation of spread */
    spreadHandle = osThreadNew(StartSpreadTask, (void *)&spread_task_params,
                               &spread_attributes);

    /* creation of flip */
    flipHandle =
        osThreadNew(StartFlipTask, (void *)&flip_task_params, &flip_attributes);

    /* creation of grip */
    gripHandle =
        osThreadNew(StartGripTask, (void *)&grip_task_params, &grip_attributes);

    /* creation of strategy */
    strategyHandle = osThreadNew(
        StartStrategyTask, (void *)&strategy_task_params, &strategy_attributes);

    /* creation of detection */
    detectionHandle =
        osThreadNew(StartDetectionTask, (void *)&detection_task_params,
...
static void MX_TIM8_Init(void) {
    ...
    if (HAL_TIM_PWM_ConfigChannel(&htim8, &sConfigOC, TIM_CHANNEL_5) !=
        HAL_OK) {
        Error_Handler();
    }
    if (HAL_TIM_PWM_ConfigChannel(&htim8, &sConfigOC, TIM_CHANNEL_6) !=
        HAL_OK) {
        Error_Handler();
    }
...
static void MX_TIM11_Init(void) {
    ...
    if (HAL_TIM_IC_ConfigChannel(&htim11, &sConfigIC, TIM_CHANNEL_1) !=
        HAL_OK) {
        Error_Handler();
    }
...
static void MX_GPIO_Init(void) {
    ...
    HAL_GPIO_WritePin(GPIOG,
                      DIRA_ROUE_GAUCHE_Pin | DIRB_ROUE_GAUCHE_Pin |
                          TRIG_AR_Pin | USB_PowerSwitchOn_Pin |
                          TRIG_GAUCHE_AV_Pin,
                      GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(
        GPIOD, DIRA_ROUE_DROITE_Pin | DIRB_ROUE_DROITE_Pin | TRIG_DROITE_AV_Pin,
        GPIO_PIN_RESET);

    /*Configure GPIO pin Output Level */
    HAL_GPIO_WritePin(GPIOB, DIRA_LEVAGE_Pin | DIRB_LEVAGE_Pin, GPIO_PIN_RESET);
    ...
    /*Configure GPIO pins : DIRA_ROUE_GAUCHE_Pin DIRB_ROUE_GAUCHE_Pin
       TRIG_AR_Pin USB_PowerSwitchOn_Pin TRIG_GAUCHE_AV_Pin */
     ...
     * TRIG_DROITE_AV_Pin */
    GPIO_InitStruct.Pin =
        DIRA_ROUE_DROITE_Pin | DIRB_ROUE_DROITE_Pin | TRIG_DROITE_AV_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /*Configure GPIO pin : INTER_EQUIPE_Pin */
    GPIO_InitStruct.Pin = INTER_EQUIPE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    HAL_GPIO_Init(INTER_EQUIPE_GPIO_Port, &GPIO_InitStruct);

    /*Configure GPIO pins : DIRA_LEVAGE_Pin DIRB_LEVAGE_Pin */
    GPIO_InitStruct.Pin = DIRA_LEVAGE_Pin | DIRB_LEVAGE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
