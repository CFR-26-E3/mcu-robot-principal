...
/* Definitions for straightRun */
osThreadId_t straightRunHandle;
const osThreadAttr_t straightRun_attributes = {
  .name = "straightRun",
  .stack_size = 1024 * 4,
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    ...
    init_dc_motor(&straight_run_task_param.left_motor, &left_wheel_motor_cfg);
    init_dc_motor(&straight_run_task_param.right_motor, &right_wheel_motor_cfg);
    ...
    init_encoder(&send_speed_task_param.left_encoder, &left_wheel_encoder_cfg);
  ...
  /* creation of straightRun */
  straightRunHandle = osThreadNew(StartStraightRunTask, (void*) &straight_run_task_param, &straightRun_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(DIRA_ROUE_DROITE_GPIO_Port, DIRA_ROUE_DROITE_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DIRB_ROUE_DROITE_GPIO_Port, DIRB_ROUE_DROITE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DIRA_ROUE_GAUCHE_Pin|DIRB_ROUE_GAUCHE_Pin, GPIO_PIN_RESET);
