...
extern StepperMotor stepper_motor_rail;
...
void TIM1_TRG_COM_TIM17_IRQHandler(void) {
    ...
    if (htim17.Instance->SR & TIM_SR_UIF) {
        stepper_motor_int_handle(&stepper_motor_rail);
    }
...
void EXTI15_10_IRQHandler(void) {
    ...
    HAL_GPIO_EXTI_IRQHandler(FDC_RAIL_AV_Pin);
    HAL_GPIO_EXTI_IRQHandler(FDC_RAIL_AR_Pin);
