...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  else if(htim_encoder->Instance==TIM2)
  {
    ...
    PB3     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = ENCA_ROUE_DROITE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(ENCA_ROUE_DROITE_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ENCB_ROUE_DROITE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(ENCB_ROUE_DROITE_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM8)
  {
    ...
    PC9     ------> TIM8_CH4
    */
    GPIO_InitStruct.Pin = PWM_ECARTEMENT_Pin|PWM_RETOURNE_1_Pin|PWM_RETOURNE_2_Pin|PWM_RETOURNE_3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM9)
  {
    ...
    PE6     ------> TIM9_CH2
    */
    GPIO_InitStruct.Pin = PWM_RETOURNE_4_Pin|PWM_SERRAGE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM10)
  {
    ...
    PF6     ------> TIM10_CH1
    */
    GPIO_InitStruct.Pin = PWM_LEVAGE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM10;
    HAL_GPIO_Init(PWM_LEVAGE_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM12)
  {
    ...
    PB15     ------> TIM12_CH2
    */
    GPIO_InitStruct.Pin = PWM_ROUE_GAUHE_Pin|PWM_ROUE_DROITE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM1)
  {
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, ENCA_LEVAGE_Pin|ENCB_LEVAGE_Pin);
  ...
  else if(htim_encoder->Instance==TIM2)
  {
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(ENCA_ROUE_DROITE_GPIO_Port, ENCA_ROUE_DROITE_Pin);

    HAL_GPIO_DeInit(ENCB_ROUE_DROITE_GPIO_Port, ENCB_ROUE_DROITE_Pin);
  ...
  else if(htim_encoder->Instance==TIM4)
  {
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, ENCA_ROUE_GAUCHE_Pin|ENCB_ROUE_GAUCHE_Pin);
